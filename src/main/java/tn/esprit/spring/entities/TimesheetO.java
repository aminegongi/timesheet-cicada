...
@Entity
public class TimesheetO implements Serializable{

	private static final long serialVersionUID = 3876346912862238239L;

	@EmbeddedId
	private Timesheet timesheetPK;
	...
	public Timesheet getTimesheetPK() {
		return timesheetPK;
	}

	public void setTimesheetPK(Timesheet timesheetPK) {
